...
const QuestionEditorVokabel = () => {
  ...
  const createQuestions = () => {
    ...
    const validRows = rows.filter(
      (row) => row.word.trim() && row.translation.trim(),
    )
    ...
    <div className="flex flex-col gap-4 rounded-xl bg-white p-4 shadow-sm">
      ...
      <div className="flex flex-col gap-3">
          ...
          {rows.map((row, index) => (
            <div key={index} className="flex gap-2">
              <input
                ...
                className="focus-visible:border-primary focus-visible:ring-primary/30 flex-1 rounded-lg border border-[var(--border-hairline)] bg-white px-3 py-2 text-sm text-gray-800 outline-none placeholder:text-gray-400 focus-visible:ring-2"
              />
              <input
                type="text"
                ...
                placeholder={t(
                  "quizz:vokabel.translationPlaceholder",
                  "Translation",
                )}
                className="focus-visible:border-primary focus-visible:ring-primary/30 flex-1 rounded-lg border border-[var(--border-hairline)] bg-white px-3 py-2 text-sm text-gray-800 outline-none placeholder:text-gray-400 focus-visible:ring-2"
              />
              <button
                ...
                className="flex items-center justify-center rounded-lg bg-red-50 p-2 text-red-600 hover:bg-red-100 disabled:cursor-not-allowed disabled:opacity-50"
        ...
        <button
          type="button"
          onClick={addRow}
          className="flex items-center justify-center gap-2 rounded-lg bg-gray-50 px-3 py-2 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-100"
        >
      ...
      <button
        ...
        className="rounded-lg bg-[var(--color-primary)] px-4 py-2 text-sm font-semibold text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
      >
