  ...
  return (
    <section aria-label={t(`game:tier.${tier}`)} className="space-y-3">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="rounded-full bg-color-field-cream px-2 py-0.5 text-[10px] font-semibold tabular-nums text-[color:var(--color-field-ink)]/60">
  ...
  return (
    ...
    >
      <header className="flex items-baseline gap-3">
        ...
        <span className="rounded-full bg-color-field-cream px-2 py-0.5 text-xs tabular-nums text-[color:var(--color-field-ink)]/60">
