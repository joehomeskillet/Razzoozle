...
const BANNER_TEXT_COLOR: Record<AchievementTier, string> = {
  bronze: "text-white",
  silver: "text-answer-text",
  gold: "text-answer-text",
  diamant: "text-answer-text",
}
...
const Leaderboard = ({
  ...
  return (
    <section className="relative mx-auto flex w-full max-w-7xl lg:max-w-[85vw] flex-1 flex-col items-center justify-start px-2">
      ...
      <div data-testid="leaderboard-table" className="flex w-full flex-col gap-2 overflow-x-hidden overflow-y-auto min-h-0 touch-pan-y overscroll-contain [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
