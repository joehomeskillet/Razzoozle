...
export const rowHoverState = "hover:bg-accent-tint hover:outline-[var(--color-primary)]"
export const rowSelectedState = "bg-accent-tint outline-[var(--color-primary)]"
...
export const rowActionHover = "hover:bg-accent-tint hover:text-accent-contrast"
