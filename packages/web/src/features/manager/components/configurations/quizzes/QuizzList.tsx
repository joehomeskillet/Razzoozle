                  ...
                  {availableLabels.length > 0 && (
                    ...
                    >
                      <Select.Trigger
                        ...
                        className="focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-primary)] flex min-h-8 cursor-pointer items-center gap-1 rounded-lg border border-[var(--border-hairline)] px-2 py-0.5 text-xs font-medium text-[var(--ink-medium)] hover:bg-[var(--surface-2)]"
                      >
                          ...
                          <Select.Viewport className="p-1">
                            {availableLabels.map((label: Label) => (
                              <Select.Item
                                ...
                                className="flex cursor-pointer items-center rounded-lg px-3 py-1.5 text-sm text-[var(--ink-muted)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-primary)] hover:bg-[var(--surface-3)] focus:bg-[var(--surface-3)]"
                              >
