    ...
    <div className={clsx("flex gap-2", className)}>
      {digits.map((digit, i) => (
        <input
          ...
          onPaste={handlePaste}
          className="focus:border-primary focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-[var(--color-primary)]/40 min-h-11 w-10 min-w-0 flex-1 rounded-lg border-2 border-gray-300 p-2 text-center text-lg font-semibold outline-none focus-visible:outline-none"
        />
      ))}
    </div>
  )
