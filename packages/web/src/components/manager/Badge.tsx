...
const TONES: Record<BadgeTone, string> = {
  ...
  primary: "bg-accent-tint text-accent-contrast",
  success: "bg-status-online-bg text-status-online-text",
  warning: "bg-status-pending-bg text-status-pending-text",
  danger: "bg-status-offline-bg text-status-offline-text",
}
...
export const assignTriggerClass =
  "relative inline-flex items-center gap-1 rounded-full border border-[var(--border-hairline)] px-2 py-0.5 text-xs font-medium text-[var(--ink-medium)] hover:bg-accent-tint hover:text-accent-contrast focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-primary)] before:absolute before:-inset-2.5 before:content-['']"
