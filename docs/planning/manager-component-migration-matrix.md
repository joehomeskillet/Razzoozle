...
| **Current primitives** | ConsoleShell SelectableRow EmptyState ActionFooter ToggleField |
...
| **Current primitives** | ConsoleShell ListRow EmptyState AlertDialog |
...
| **Current primitives** | ConsoleShell SectionCard Badge ActionFooter |
...
| **Required changes** | 1. Add/verify PageHeader. 2. Introduce rank grouping (Tabs/Accordion) — currently a flat tier list; TierHeader is a static divider, no tabs exist. 3. Within each rank, replace oversized cards with ListRow: name, description, trigger, threshold, bonus points, actions (edit, delete). 4. Extend SettingRow (LabelRow/ToggleField) with restart-badge + status slots. 5. Implement dirty-state save bar (extend ActionFooter). 6. Document reset scope: achievement / rank / all defaults. 7. Preserve achievement logic server-side. |
...
| **Current primitives** | ConsoleShell ListRow EmptyState FilterPill Badge AlertDialog OverflowMenu ActionFooter |
...
| **Current primitives** | ConsoleShell PageHeader EmptyState FilterPill Badge AlertDialog |
...
| **Current primitives** | ConsoleShell EmptyState FilterPill Badge AlertDialog |
...
| **Current primitives** | ConsoleShell ListRow EmptyState Badge AlertDialog DialogPanel OverflowMenu ActionFooter |
...
| **Current primitives** | ConsoleShell PageHeader ListRow EmptyState Badge AlertDialog DialogPanel ActionFooter |
...
| **Current primitives** | ConsoleShell PageHeader EmptyState SectionCard |
...
| **Current primitives** | ConsoleShell AlertDialog DialogPanel ActionFooter |
...
| **Current primitives** | ConsoleShell EmptyState SectionCard AlertDialog ActionFooter FormSection LabelRow |
...
| **Current primitives** | ConsoleShell FilterPill Badge FormSection ToggleField |
...
| **Current primitives** | ConsoleShell |
...
| **Current primitives** | ConsoleShell ListRow EmptyState Badge AlertDialog OverflowMenu ActionFooter |
...
| **Current primitives** | ConsoleShell ListRow EmptyState SectionCard Badge |
