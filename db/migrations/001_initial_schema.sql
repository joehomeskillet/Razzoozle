...
CREATE INDEX IF NOT EXISTS idx_games_config_updated_at ON games_config(updated_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_quizzes_archived ON quizzes(archived);
CREATE INDEX IF NOT EXISTS idx_quizzes_created_at_desc ON quizzes(created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_game_results_quiz_id_created_at ON game_results(quiz_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_game_results_date_desc ON game_results(date DESC);
...
CREATE INDEX IF NOT EXISTS idx_solo_results_quiz_id_score_desc ON solo_results(quiz_id, score DESC);
...
CREATE INDEX IF NOT EXISTS idx_themes_created_at_desc ON themes(created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_theme_revisions_theme_id_revision_number ON theme_revisions(theme_id, revision_number DESC);
...
CREATE INDEX IF NOT EXISTS idx_achievements_config_enabled ON achievements_config(enabled);
...
CREATE INDEX IF NOT EXISTS idx_catalog_entries_source_added_at ON catalog_entries(source, added_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_media_assets_category_source_uploaded_at ON media_assets(category, source, uploaded_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_assignments_quiz_id_assigned_to ON assignments(quiz_id, assigned_to);
CREATE INDEX IF NOT EXISTS idx_assignments_assigned_at_desc ON assignments(assigned_at DESC);
